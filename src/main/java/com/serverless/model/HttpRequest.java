...
public class HttpRequest {
    ...
    public HttpRequest withResource(String resource) {
    ...
    public HttpRequest withStageVariables(Map<String, String> stageVariables) {
    ...
    public String toString() {
        ...
        builder.append("HttpRequest [resource=");
